...
#ifndef SRC_Classifier3nosdp_H_
#define SRC_Classifier3nosdp_H_
...
public:
  ...
  inline void init(Options options) {
	  ...
	  _rel_hidden_inputsize = _relrnn_outputsize*2; // left+right
	  ...
	  _rel_output_layer.initial(_rellabelSize, _rel_hidden_outputsize, true, 80, 2);
    	...
    	cout<<"Classifier3 nosdp initial"<<endl;
  }
  ...
  inline dtype processRel(const vector<Example>& examples, int iter) {
    ...
    for (int count = 0; count < example_num; count++) {
      ...
      int sdp_e1_size = example._between_words.size();
      int sdp_e2_size = example._between_words.size();
      ...
      for(int i=0;i<sdp_e1_size;i++) {
    	  int idx = example._between_words[i];
      ...
      concat(relrnn_hidden_bottomup_e1[sdp_e1_size-1],
    		  relrnn_hidden_topdown_e1[0],
			  hidden_input);
      ...
      unconcat(relrnn_hidden_bottomup_e1_Loss[sdp_e1_size-1],
    		  relrnn_hidden_topdown_e1_Loss[0],
			  hidden_inputLoss);
