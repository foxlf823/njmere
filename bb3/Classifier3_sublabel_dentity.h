...
#ifndef SRC_Classifier3sublabeldentity_H_
#define SRC_Classifier3sublabeldentity_H_
...
class Classifier3_sublabel_dentity {
...
public:
  ...
  inline void init(Options options) {
	  ...
	  _rel_output_layer.initial(_rellabelSize, _rel_hidden_outputsize, true, 80, 2);
    	...
    	cout<<"Classifier3_sublabel_dentity initial"<<endl;
  }
