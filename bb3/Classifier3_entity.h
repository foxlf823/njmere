...
#ifndef SRC_Classifier3entity_H_
#define SRC_Classifier3entity_H_
...
public:
  ...
  inline void init(Options options) {
	  ...
	  _rel_hidden_inputsize = _relrnn_outputsize*4 + _nerrnn_outputsize*2; // e12a+e22a+a2e1+a2e2
	  ...
	  _rel_output_layer.initial(_rellabelSize, _rel_hidden_outputsize, true, 80, 2);
    	...
    	cout<<"Classifier3 entity initial"<<endl;
  }
